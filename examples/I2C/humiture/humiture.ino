...
DFRobot_Lcd_IIC lcd;
DFRobot_Lcd_IIC::sControlinf_t *bar1;
DFRobot_Lcd_IIC::sControlinf_t *bar2;
...
void setup(void) {
  ...
  //创建图标
  lcd.drawIcon(0, 64, DFRobot_Lcd_IIC::eIconThermometer, 200);
  lcd.drawIcon(-8, 84, DFRobot_Lcd_IIC::eIconRaindrops, 200);
  lcd.drawIcon(120, 2, DFRobot_Lcd_IIC::eIconRains, 300);
  lcd.drawIcon(122, 80, DFRobot_Lcd_IIC::eIconLaugh, 320);
  //显示当前时间
