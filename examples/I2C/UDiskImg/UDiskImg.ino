...
DFRobot_LcdDisplay::sControlinf_t* img1;
DFRobot_LcdDisplay::sControlinf_t* img2;
...
void setup(void)
{
  ...
  img1 = lcd.drawDiskImg(/*x=*/0, /*y=*/0, /*文件路径名(String类型)*/"/1.bmp", /*缩放指数*/256);
  delay(1000);
  lcd.lvglDelete(img1);
  img2 = lcd.drawDiskImg(0, 0, "/2.png", 256);
  delay(1000);
