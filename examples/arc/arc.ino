/**!
 * @file arc.ino
 * @brief Angle Control Example
 * @details Create an angle control and then control the angle to change.
...
void loop(void)
{
  //Controlling the angle of the angle control
  lcd.setArcRotation(arc, /*Angle*/0);
  delay(2000);
